  ...
  <div id="app">
        ...
        <tr>
            <td style="height:24px;padding: 6px;" colspan="2">
                <status-bar v-bind:coords="coords" v-bind:tile="level.tile" v-bind:hints="hints"></status-bar>
            </td>
        </tr>
    </table>
  </div>
...
<script>
  ...
  export default {
    ...
    events: {
        ...
        'changetile': function (indexes) { this.$emit('changetile', indexes); },
        'tileselected': function (x, y) { this.$emit('tileselected', x, y); },
        'notileselected': function () { this.$emit('notileselected'); },
        'rootselected': function () { this.$emit('rootselected'); },
