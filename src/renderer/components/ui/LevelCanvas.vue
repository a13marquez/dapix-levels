...
export default {
    ...
    methods: {
        ...
        onStageMouseMove(mouseEvent) {
            switch (this.tool) {
                case 'select': this.$refs['tool-select'].onMouseDrag(mouseEvent); break;
                case 'move': this.$refs['tool-move'].onMouseDrag(mouseEvent); break;
                case 'brush': this.$refs['tool-brush'].onMouseDrag(mouseEvent); break;
                case 'eraser': this.$refs['tool-eraser'].onMouseDrag(mouseEvent); break;
                case 'line': this.$refs['tool-line'].onMouseDrag(mouseEvent); break;
                case 'rectangle': this.$refs['tool-rectangle'].onMouseDrag(mouseEvent); break;
                case 'ellipse': this.$refs['tool-ellipse'].onMouseDrag(mouseEvent); break;
                case 'fill': this.$refs['tool-fill'].onMouseDrag(mouseEvent); break;
            }
        ...
        onStageMouseDown(mouseEvent) {
            switch (this.tool) {
                case 'select': this.$refs['tool-select'].onMouseDown(mouseEvent); break;
                case 'move': this.$refs['tool-move'].onMouseDown(mouseEvent); break;
                case 'brush': this.$refs['tool-brush'].onMouseDown(mouseEvent); break;
                case 'eraser': this.$refs['tool-eraser'].onMouseDown(mouseEvent); break;
                case 'line': this.$refs['tool-line'].onMouseDown(mouseEvent); break;
                case 'rectangle': this.$refs['tool-rectangle'].onMouseDown(mouseEvent); break;
                case 'ellipse': this.$refs['tool-ellipse'].onMouseDown(mouseEvent); break;
            }
        },

        onStageMouseUp(mouseEvent) {
            switch (this.tool) {
                case 'select': this.$refs['tool-select'].onMouseUp(mouseEvent); break;
                case 'move': this.$refs['tool-move'].onMouseUp(mouseEvent); break;
                case 'brush': this.$refs['tool-brush'].onMouseUp(mouseEvent); break;
                case 'eraser': this.$refs['tool-eraser'].onMouseUp(mouseEvent); break;
                case 'eyedropper': this.$refs['tool-eyedropper'].onMouseUp(mouseEvent); this.tool = 'brush'; break;
                case 'line': this.$refs['tool-line'].onMouseUp(mouseEvent); break;
                case 'rectangle': this.$refs['tool-rectangle'].onMouseUp(mouseEvent); break;
                case 'ellipse': this.$refs['tool-ellipse'].onMouseUp(mouseEvent); break;
                case 'fill': this.$refs['tool-fill'].onMouseUp(mouseEvent); break;
            }
        },
